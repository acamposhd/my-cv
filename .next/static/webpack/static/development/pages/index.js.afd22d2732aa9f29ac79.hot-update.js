...
var Resume = {
  ...
  education: [{
    ...
    title: ['Carrera Bases de Datos', 'Carrera Inglés para Profesionales', 'Carrera Desarrollo Backend con Go', 'Curso de Java SE', 'Curso Node.js', 'Curso de MongoDB', 'Curso de Buenas Prácticas', 'Curso de HTML Y CSS', 'Curso de Seguridad Informática', 'Curso PHP con Laravel', 'Curso de POO', 'Curso de Redes de Internet', 'Curso de SCRUM', 'Curso de SQL y MySQL', 'Curso de Bases de Datos', 'Curso de Terminal y Línea de Comandos', 'Curso de Fundamentos de Google Cloud Platform'],
...
//# sourceMappingURL=index.js.afd22d2732aa9f29ac79.hot-update.js.map